...
// NewPostSsoParams creates a new PostSsoParams object
// with the default values initialized.
func NewPostSsoParams() *PostSsoParams {
	var ()
	return &PostSsoParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostSsoParamsWithTimeout creates a new PostSsoParams object
...
// NewPostSsoParamsWithContext creates a new PostSsoParams object
...
// NewPostSsoParamsWithHTTPClient creates a new PostSsoParams object
...
/*PostSsoParams contains all the parameters to send to the API endpoint
for the post sso operation typically these are written to a http.Request
*/
...
func (o *PostSsoParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Body == nil {
		o.Body = new(models.AuthCodeRequest)
	}
