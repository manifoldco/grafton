...
// NewDeleteResourcesIDParams creates a new DeleteResourcesIDParams object
// with the default values initialized.
func NewDeleteResourcesIDParams() *DeleteResourcesIDParams {
	var ()
	return &DeleteResourcesIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteResourcesIDParamsWithTimeout creates a new DeleteResourcesIDParams object
...
// NewDeleteResourcesIDParamsWithContext creates a new DeleteResourcesIDParams object
...
// NewDeleteResourcesIDParamsWithHTTPClient creates a new DeleteResourcesIDParams object
...
/*DeleteResourcesIDParams contains all the parameters to send to the API endpoint
for the delete resources ID operation typically these are written to a http.Request
*/
type DeleteResourcesIDParams struct {
